...
# This description is used to generate tags and improve search results.
  ...
  s.description      = <<-DESC
  'A simple & light weight open source library for all standard social login like: apple, google, facebook, Which provides the support for both iOS frameworks UIKit & SwiftUI.'
                       DESC
  ...
  s.source_files = 'Sources/MjSocialLogins/**/*'
